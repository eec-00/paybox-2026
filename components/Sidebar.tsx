...
import { FileText, PlusCircle, UserCog, Car, LayoutDashboard } from 'lucide-react'

export type Section = 'dashboard' | 'registros' | 'nuevo-pago' | 'vehiculos' | 'tutoriales' | 'administracion'
